...
現場では、曖昧さを戻すための往復が増え、レビューの基準ぶれも起こりやすい——そんな課題に繰り返し直面しました。
...
オリジナルじゃなくてもいいスクールの課題でもいい
なぜ作ろうと思ったのか、作らなければならなかったのか、自分なりの理由を書く。
└ ウェブアプリケーションを開発する中で、一通りのスキルセットを身につけるためにこのアプリを参考アプリとして作成しました。みたいな。

## 概要

このアプリがどういう動作をするもので、何をしたのかが、箇条書きで淡々と適切にわかりやすく書く。
